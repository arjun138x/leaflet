...
import PointZoomIntoHexagon from "./components/individual-code/PointZoomIntoHexagon";
...
function App() {
  return (
    <>
      ...
      {/* ------ TOWER WITH NETWORK COVERAGE GEOJSON AS A MultiPolygon   ------*/}
      <PointZoomIntoHexagon />
